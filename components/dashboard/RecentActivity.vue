<template>
  <div
    class="bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col"
  >
      ...
      <div class="space-y-6">
        ...
        >
          <div class="mt-0.5 relative">
            <div
              class="h-8 w-8 rounded-full bg-gray-50 border border-gray-100 flex items-center justify-center"
            >
              <component
                :is="item.icon"
            ...
            <div
              ...
              class="absolute top-8 left-4 bottom-[-24px] w-px bg-gray-100"
            />
          </div>
          <div class="flex-1">
...
<script setup>
import { FilePlus, UserCheck, CalendarPlus } from "lucide-vue-next";
