...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout" }, _attrs))}><aside class="sidebar"><div class="brand"><div class="logo">\u{1F469}\u200D\u{1F3EB}</div><div class="brand-text">Teacher</div></div><nav class="side-nav">`);
...
//# sourceMappingURL=teacher-xm7-j1NW.mjs.map
