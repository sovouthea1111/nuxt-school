...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let model = reactive({ studentId: ((_a = students.value[0]) == null ? void 0 : _a.id) || "", subject: "Mathematics", exam: "Midterm", score: 80, date: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10) });
    function onUpdate(v) {
...
//# sourceMappingURL=entry-Dz28O1jC.mjs.map
