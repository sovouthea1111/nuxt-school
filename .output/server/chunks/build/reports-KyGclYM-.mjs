  ...
  setup(__props) {
    ...
    const summary = computed(() => {
      ...
      return Array.from(map.entries()).map(([id, m]) => {
        ...
        return { studentId: id, name: (s == null ? void 0 : s.name) || "Unknown", grade: (s == null ? void 0 : s.grade) || "-", present: m.present, absent: m.absent, late: m.late, rate };
...
//# sourceMappingURL=reports-KyGclYM-.mjs.map
