...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const open = ref(true);
    let model = reactive({
      name: ((_a = klass.value) == null ? void 0 : _a.name) || "",
      grade: ((_b = klass.value) == null ? void 0 : _b.grade) || "Grade 1",
      section: ((_c = klass.value) == null ? void 0 : _c.section) || "Red",
      teacher: ((_d = klass.value) == null ? void 0 : _d.teacher) || "",
      room: ((_e = klass.value) == null ? void 0 : _e.room) || ""
    });
    function onUpdate(v) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/classes/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-CA9KLfnx.mjs.map
