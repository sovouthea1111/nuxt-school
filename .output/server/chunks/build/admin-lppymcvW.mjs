...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout" }, _attrs))}><aside class="sidebar"><div class="brand"><div class="logo">\u{1F6E0}\uFE0F</div><div class="brand-text">Admin</div></div><nav class="side-nav">`);
...
//# sourceMappingURL=admin-lppymcvW.mjs.map
