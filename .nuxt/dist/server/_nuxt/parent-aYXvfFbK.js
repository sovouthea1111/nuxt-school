...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout" }, _attrs))}><aside class="sidebar"><div class="brand"><div class="logo">👨‍👩‍👧‍👦</div><div class="brand-text">Parent</div></div><nav class="side-nav">`);
...
//# sourceMappingURL=parent-aYXvfFbK.js.map
