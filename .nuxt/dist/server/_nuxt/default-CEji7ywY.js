...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout" }, _attrs))}><aside class="sidebar"><div class="brand"><div class="logo">📚</div><div class="brand-text">Idea International</div></div><nav class="side-nav">`);
      ...
      _push(`</nav></aside><section class="content"><header class="topbar"><input class="search" placeholder="What do you want to find?"><div class="topbar-actions"><button class="icon-btn">🔔</button><button class="icon-btn">💬</button><div class="avatar-chip"><div class="avatar">P</div><div><div style="${ssrRenderStyle({ "font-weight": "700" })}">Priscilla Lily</div><div class="help">Admin</div></div><span>▾</span></div></div></header><main class="container container--wide">`);
...
//# sourceMappingURL=default-CEji7ywY.js.map
